...
public class Repository implements Serializable {
	...
	public Repository() {
		...
		this.arrAnswers = null;
	}
	
	public void setRepository(String profession) {
		this.profession = profession;
		this.arrQuestions = new ArrayList<>();
		this.arrAnswers = new ArrayList<>();
	}
	...
	public boolean addAnswerToRepository(String ans) {
		...
		Answer newAnswer = AnswerFactory.create();
		newAnswer.setContent(ans);
	...
	public boolean addAnswerToQuestion(int numQue, int numAns, boolean correctAns) {
		...
		// it returns false.
		AnswerToQuestion answer = AnswerToQuestionFactory.create();
		answer.setAnswerToQuestion(this.arrAnswers.get(numAns - 1), correctAns);
	...
	public boolean addQuestion(String que, Question.eDifficulty difficulty, boolean typeQue) {
		...
		if (typeQue)
			newQuestion = CloseQuestionsFactory.create();
		else
			newQuestion = OpenQuestionFactory.create();
		newQuestion.setQuestion(que, difficulty);
